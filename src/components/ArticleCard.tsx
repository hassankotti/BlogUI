...
const ArticleCard = ({ article }) => {
    return (
        <div className="md:w-64 w-full bg-white dark:bg-heavy-metal-800 dark:border-heavy-metal-700 overflow-hidden">
            <div className="flex-col items-center overflow-hidden">
                <img className="aspect-square object-cover rounded-t" src={article.imgUrl} alt="" />
