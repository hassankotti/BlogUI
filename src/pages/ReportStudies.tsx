...
const ReportStudies = () => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Blog | التقارير والدراسات</title>
      ...
      <div className='container py-6  flex-col space-y-10 bg-gray-50 my-8 dark:bg-heavy-metal-900 min-h-screen'>
        <h1 className='font-medium text-2xl  text-center dark:text-white'>التقارير والدراسات</h1>
        <div className='grid md:grid-cols-3 gap-6 container relative'>
